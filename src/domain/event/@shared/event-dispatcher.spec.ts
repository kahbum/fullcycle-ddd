...
import CustomerAddressChangedHandler from "../product/handler/customer-address-changed.handler";
import CustomerCreatedHandler1 from "../product/handler/customer-created-1.handler";
import CustomerCreatedHandler2 from "../product/handler/customer-created-2.handler";
